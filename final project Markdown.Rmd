...
test<-matchTeamAttHA[matchTeamAttHA$seasonStart.x==2015,]
train<-matchTeamAttHA[matchTeamAttHA$seasonStart.x<2015,]
#testing dataset for Y
test_win<-test$homeWin
...
# For predicted probabilities greater than 0.5, assign Y to be "Win"; otherwise assign Y to be "Lose"
glm_pred = rep("Down", 380)
glm_pred[glm_probs > .5] = "Win"


# Confusion matrix
table(glm_pred, test_win)
