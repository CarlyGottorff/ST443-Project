...
```{r}
#multinomial logistic regression and repeated CV
trctrl_logitB<- trainControl(method = "repeatedcv", number = 10, repeats = 3)
...
```{r}
#binomial logistic regression with binary calsifier homeWin and repeat CV
