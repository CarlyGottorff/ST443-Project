...
```{r}
#box plots 
plot(train$homeOutcome, train$homeBuildUpPlaySpeed)
plot(train$homeOutcome, train$homeBuildUpPlayPassing)
plot(train$homeOutcome, train$homeChanceCreationPassing)
plot(train$homeOutcome, train$homeChanceCreationCrossing)
plot(train$homeOutcome, train$homeChanceCreationShooting)
plot(train$homeOutcome, train$homeDefencePressure)
plot(train$homeOutcome, train$homeDefenceAggression)
plot(train$homeOutcome, train$homeDefenceTeamWidth)
plot(train$homeOutcome, train$awayBuildUpPlaySpeed)
plot(train$homeOutcome, train$awayBuildUpPlayPassing)
plot(train$homeOutcome, train$awayChanceCreationPassing)
plot(train$homeOutcome, train$awayChanceCreationCrossing)
plot(train$homeOutcome, train$awayChanceCreationShooting)
plot(train$homeOutcome, train$awayDefencePressure)
plot(train$homeOutcome, train$awayDefenceAggression)
plot(train$homeOutcome, train$awayDefenceTeamWidth)
...
#the logistic regression for all 3 categories is better at predicting the outcome. Therefore we will continue to use the 3 factor level data for win, loose, tie for the rest of our models. 
```
...
grid_radial<- expand.grid(sigma = .01,
 C = c(0.05,0.1,0.25))
svm_Radial_Grid<- train(homeOutcome ~., data = X, method = "svmRadial",
...
#training
knn_fit<-train(homeOutcome~., data=X, method="knn", trControl=trctrl_knn, preProcess=c("center","scale"))
knn_fit
plot(knn_fit)
varImp(knn_fit)
...
```{r}
#Linear discriminant analysis with repeated CV at 10 folds 
require(MASS)
X<-train[,-1]
