...
table(predicted.multiLogit, test[,18])
...
svm_Radial <- train(homeOutcome~., data=X, method = "svmRadial",trControl=trctrl, preProcess = c("center", "scale"))
...
#training
knn_fit<-train(homeOutcome~., data=X, method="knn", trControl=trctrl_knn, preProcess=c("center","scale"), tuneLength=10)
knn_fit
plot(knn_fit)
varImp(knn_fit)
